...
CREATE OR REPLACE PROCEDURE Emp_Info (EmpNo_IN IN employee.empno%TYPE,
                                      EmpName_Out OUT employee.empname%TYPE,
                                      Phone OUT employee.phone%TYPE, 
                                      PosNo_Out OUT employee.posno%TYPE,
                                      Gender OUT employee.gender%TYPE)
IS BEGIN

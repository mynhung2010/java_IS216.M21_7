...
public class ThongTinDichVuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(txtMaDichVu, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 130, 110, 23));
        add(txtTenDichVu, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 180, 110, -1));
        add(txtGia, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 220, 113, 20));

        cbbLoaiHinh.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ngoài trời", "Trong nhà" }));
        add(cbbLoaiHinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 260, 90, 20));
